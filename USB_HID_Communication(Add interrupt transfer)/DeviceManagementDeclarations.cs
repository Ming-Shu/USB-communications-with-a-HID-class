...
*/
            ...
            [DllImport("setupapi.dll", SetLastError = true)]// Retrieves a handle to a SP_DEVICE_INTERFACE_DATA structure for a device.
            ...
            [DllImport("setupapi.dll", SetLastError = true, CharSet = CharSet.Auto)]//Retrieves a device information set for a specified group of devices.
            internal static extern IntPtr SetupDiGetClassDevs(ref Guid ClassGuid, IntPtr Enumerator, IntPtr hwndParent, Int32 Flags);

            [DllImport("setupapi.dll", SetLastError = true, CharSet = CharSet.Auto)]//Retrieves an SP_DEVICE_INTERFACE_DETAIL_DATA structure containing information about a device.
